...
console.log('🚀 Using MockVehicleService with 50,000 sample vehicles for testing');
console.log('   To use real MySQL later, update the routes to use VehicleService');
...
export const getVehicles: RequestHandler = async (req, res) => {
  try {
    ...
    if (req.query.maxMileage) filters.maxMileage = parseInt(req.query.maxMileage as string);
    ...
    if (req.query.drivetrain) filters.drivetrain = req.query.drivetrain as string;
