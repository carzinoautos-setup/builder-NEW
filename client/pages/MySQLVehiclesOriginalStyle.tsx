    ...
    >
      ...
      <div className="flex flex-col lg:flex-row min-h-screen max-w-[1325px] mx-auto pb-12">
        ...
        >
          ...
          >
            {/* Applied Filters rendered in mobile sticky and desktop areas; omitted here to avoid duplication */}
            ...
            {!mobileFiltersOpen && (
              <div className="lg:hidden mb-4">
                <form
                  onSubmit={handleUnifiedSearchSubmit}
                  className="space-y-2"
                >
