      ...
      <div className="flex flex-col lg:flex-row min-h-screen max-w-[1325px] mx-auto">
        ...
        >
          ...
          <div className="p-4">
            ...
            <div className="lg:hidden mb-4 sticky bottom-0 z-80 bg-white border-t border-gray-200 px-4 py-3">
        ...
        <div className="flex-1 flex flex-col">
          ...
          <div className="lg:hidden">
            ...
            {!mobileFiltersOpen && ((appliedLocation && appliedRadius !== "nationwide") ||
              ...
              appliedFilters.paymentMin ||
              appliedFilters.paymentMax) && (
              <div className="lg:hidden sticky top-16 z-40 px-3 pt-3 bg-white">
