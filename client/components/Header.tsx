      ...
      <header className="w-full bg-white shadow-sm">
        <div className="mx-auto w-full max-w-[1325px] px-4 sm:px-6 lg:px-10 box-border">
          <div className="flex items-center justify-between h-[98px]">
            ...
            {/* Center / Nav */}
            <nav className="flex items-center flex-1 justify-center min-w-0 gap-[23px] hidden lg:flex">
            ...
            <div className="flex items-center gap-3">
              <div className="hidden md:flex items-center gap-3 max-w-[360px]">
                <button
                  aria-label="search"
                  className="p-[6px] rounded-[8px] bg-transparent border-0 transition-colors duration-150 hover:bg-gray-100"
                >
                  <svg
                    width="24"
                    height="24"
              ...
              <button
                aria-label="menu"
                className="flex items-center border border-red-600 rounded-[14px] border-[0.888889px] gap-2 justify-center px-3 py-2 md:hidden text-red-600"
              >
                ...
                <div className="text-red-600 font-medium">Sign up</div>
              </button>

              {/* Desktop/menu fallback button */}
              <button className="hidden md:inline-flex p-2 rounded-lg border border-red-600 text-red-600 lg:hidden" aria-label="menu-desktop">
                <svg width="20" height="20" viewBox="0 0 20 20" fill="none" xmlns="http://www.w3.org/2000/svg" className="w-5 h-5">
