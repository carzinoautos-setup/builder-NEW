      ...
      >
        ...
        <div className="mx-auto w-full max-w-[1325px] px-4 sm:px-6 lg:px-10 box-border">
          <div className="flex items-center justify-between h-[70px] md:h-[98px]">
            ...
            <nav
              className="hidden lg:flex flex-1 items-center justify-center min-w-0 gap-[23px]"
              aria-label="Primary"
            >
              <a
            ...
            <div className="flex items-center gap-3">
              <div className="hidden md:flex items-center gap-3 max-w-[360px]">
                <button
                  aria-label="search"
                  className="p-[6px] rounded-[8px] hover:bg-gray-100"
                >
                  <svg
                    width="24"
                    height="24"
                ...
                >
                  ...
                  >
                    <path
                      d="M21.6484 19.875C20.2206 17.4065 18.0203 15.6365 15.4525 14.7975C16.7226 14.0414 17.7094 12.8892 18.2614 11.5179C18.8134 10.1467 18.8999 8.63211 18.5078 7.20688C18.1157 5.78165 17.2666 4.52454 16.0909 3.6286C14.9151 2.73266 13.4778 2.24744 11.9996 2.24744C10.5215 2.24744 9.08414 2.73266 7.90842 3.6286C6.73269 4.52454 5.88358 5.78165 5.49146 7.20688C5.09935 8.63211 5.18592 10.1467 5.73788 11.5179C6.28984 12.8892 7.27668 14.0414 8.54683 14.7975C5.97902 15.6356 3.77871 17.4056 2.35089 19.875C2.29853 19.9604 2.2638 20.0554 2.24875 20.1544 2.2337 20.2534 2.23863 20.3544 2.26326 20.4515"
                      fill="#24272C"
                    />
                  </svg>
                ...
                {vehiclesOpen && (
                  <div className="grid grid-cols-3 gap-3 pt-3 pb-2">
                    ...
                    const vehicleImages: Record<string, string> = {
                      ...
                      "Crossover/SUV": "https://cdn.builder.io/api/v1/image/assets%2F4d1f1909a98e4ebc8068632229306ce4%2F1812e90034a34b29a52d7338439737c4",
