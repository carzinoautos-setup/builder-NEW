...
export default function Header({ topTemplate }: HeaderProps) {
  ...
  const mobilePanelClass =
    "md:hidden absolute left-0 right-0 top-full bg-white shadow-md z-[80] max-h-[calc(100vh-98px)] overflow-auto transition-all duration-150 origin-top " +
          ...
          <div className="flex items-center justify-between h-[98px]">
            ...
            <div className="flex items-center gap-3">
              <div className="hidden md:flex items-center gap-3 max-w-[360px]">
                ...
                <a href="#" className="flex items-center gap-2 px-2 py-1 rounded-[8px] hover:bg-gray-50 text-red-600 font-semibold">
                  <svg width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg" className="w-6 h-6">
