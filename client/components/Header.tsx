      ...
      >
        ...
        <div className="mx-auto w-full max-w-[1325px] px-4 sm:px-6 lg:px-10 box-border">
          <div className="flex items-center justify-between h-[70px] md:h-[98px]">
            ...
            >
              <a
                className="text-gray-800 font-bold whitespace-nowrap underline decoration-transparent hover:decoration-gray-400 decoration-2 underline-offset-2 hover:text-red-600 transition-colors"
                href="/cars-for-sale/"
              >
                Cars For Sale
              </a>
            ...
            <div className="flex items-center gap-3">
              <div className="hidden md:flex items-center gap-3 max-w-[360px]">
                ...
                >
                  <img src="https://cdn.builder.io/api/v1/image/assets%2F4d1f1909a98e4ebc8068632229306ce4%2F9c67e3a6b2074b1589d8a96750b2a465?format=webp" alt="Login" className="w-6 h-6 transform" style={{ filter: 'brightness(0)', transform: 'scale(1.15)' }} />
